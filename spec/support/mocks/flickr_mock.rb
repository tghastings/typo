...
# Mock FlickRaw to avoid needing a shared secret
# Override the api_key= setter to not check for shared_secret
module FlickRaw
  class << self
    # Override api_key= to not raise about missing shared_secret
