...
describe 'Public Routes', type: :routing do
  ...
  describe 'XmlController' do
    ...
    it 'routes GET /sitemap.xml to xml#feed with googlesitemap format' do
      expect(get: '/sitemap.xml').to route_to(controller: 'xml', action: 'feed', format: 'googlesitemap',
                                              type: 'sitemap')
    end
  end
  ...
  describe 'ThemeController' do
    it 'routes GET /stylesheets/theme/style.css to theme#stylesheets' do
      expect(get: '/stylesheets/theme/style.css').to route_to(controller: 'theme', action: 'stylesheets',
                                                              filename: 'style.css')
    end

    it 'routes GET /javascripts/theme/main.js to theme#javascript' do
      expect(get: '/javascripts/theme/main.js').to route_to(controller: 'theme', action: 'javascript',
                                                            filename: 'main.js')
    end
