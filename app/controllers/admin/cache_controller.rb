...
class Admin::CacheController < Admin::BaseController
  def index
    ...
    FileUtils.mkdir_p(TypoBlog::Application.config.action_controller.page_cache_directory) unless File.exist?(TypoBlog::Application.config.action_controller.page_cache_directory)
