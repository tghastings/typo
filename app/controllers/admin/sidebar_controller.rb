...
module Admin
  class SidebarController < Admin::BaseController
    def index
      @available = available
      ...
      flash_sidebars
      begin
        @active ||= Sidebar.where.not(active_position: nil).order('active_position ASC').to_a
