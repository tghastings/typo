...
class MTMigrate
  ...
  def convert_entries
    ...
    mt_entries.each do |entry|
      ...
      ActiveRecord::Base.connection.select_all(%(
        ...
        a.categories.push_with_attributes(Category.find_by_name(c['category_label']),
                                          is_primary: c['placement_is_primary'])
      end
  ...
  def parse_options
    ...
    return if options.include?(:blog_id) && options.include?(:mt_db)
