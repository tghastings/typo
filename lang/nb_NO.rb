...
Localization.define('nb_NO') do |l|
  ...
  l.store 'An email has been successfully sent to your address with your new password',
          'En epost er sendt til din adresse med ditt nye passord'
  ...
  l.store 'Oops, something wrong happened. Cache could not be cleaned',
          'Ojsann, noe galt hendte. Cache kunne ikke rengjøres'
  ...
  l.store 'You are late from at least one major version of Typo. You should upgrade immediately. Download and install %s',
          'Du bruker en gammel versjon av Typo. Du bør oppgradere snarest. Last ned og installer %s'
  ...
  l.store "There's a new version of Typo available which may contain important bug fixes. Why don't you upgrade to %s ?",
          'Det finnes en ny versjon av Typo som kan inneholde viktige feilrettelser. Hva med å oppgradere til %s?'
  l.store "There's a new version of Typo available. Why don't you upgrade to %s ?",
          'Det finnes en ny versjon av Typo. Hva med å oppgradere til %s?'
  ...
  l.store 'Please review and save the settings before continuing',
          'Vennligst les igjennom og lagre innstillingene før du fortsetter'
  ...
  l.store 'It seems something went wrong. Maybe some of your sidebars are actually missing and you should either reinstall them or remove them manually',
          'Noe gikk galt. Kanskje en av dine sidekolonner mangler og du burde reinstallere den eller fjerne den manuelt'
  ...
  l.store 'You need a permalink format with an identifier : %%title%%',
          'Du må bruke et permalenkeformat med identifikator: %%title%%'
  l.store "Can't end in .rss or .atom. These are reserved to be used for feed URLs",
          'Kan ikke slutte på .rss eller .atom. Disse er reserverte for feed-URLer'
  ...
  l.store 'There are currently %d files in cache for a total amount of %d Kb',
          'Det finnes for øyeblikket %d filer i cachen som utgjør totalt %d kB'
  l.store 'Sweep cache', ''
  l.store 'Cache', 'Cache'
  ...
  l.store 'Excerpts are posts summaries that are shown on your blog homepage only but won’t appear on the post itself',
          'Utdrag er oppsummeringer som vises på bloggsiden, men ikke i artikkelen'
  ...
  l.store 'This place gives you a quick overview of what happens on your Typo blog and what you can do. Maybe will you want to %s, %s or %s.',
          'Dette stedet gir deg en rask oversikt over hva som foregår på din Typo-blogg og hva du kan gjøre. Kanskje du ønsker å %s, %s eller %s.'
  ...
  l.store 'If you need help, %s. You can also browse our %s or %s to customize your Typo blog.',
          'Hvis du behøver hjelp, %s. Du kan også se gjennom vår %s eller %s for å tilpasse Typo-bloggen din.'
  ...
  l.store '%d articles and %d comments were posted since your last connexion',
          '%d artikler og %d kommentarer siden forrige besøk'
  ...
  l.store 'This comment by <strong>%s</strong> was flagged as spam, %s?',
          'Denne kommentaren av <strong>%s</strong> er flagget som Spam, %s?'
  ...
  l.store "You robots.txt file is not writeable. Typo won't be able to write it",
          'Din robots.txt er ikke skrivbar. Typo vil ikke kunne skrive til den'
  ...
  l.store 'Maybe you want to moderate feedbacks when turning this on',
          'Kanskje du ønsker å moderere feedbacks når du slår på denne'
  ...
  l.store 'Typo offers you the ability to create a custom URL structure for your permalinks and archives. This can improve the aesthetics, usability, and forward-compatibility of your links.',
          'Typo tilbyr deg muligheten til å opprette en tilpasset URL-struktur for dine permalenker og arkiver. Dette kan forbedre estetikken, brukervennligheten og foroverkompatibiliteten til dine lenker.'
  l.store 'You can custom your URL structure using the following tags:',
          'Du kan tilbasse URL-strukturen din ved å bruke følgende tags:'
  l.store 'your article slug. <strong>Using this slug is mandatory</strong>.',
          'Din artikkel-slug. <strong>Det er påkrevd å bruke denne slug</strong>.'
  ...
  l.store 'Replaced with the article categories (comma separated)',
          'Erstattet med artikkelens kategorier (kommaseparert)'
  ...
  l.store 'You can enable site wide feeback moderation. If you do so, no comment or trackback will appear on your blog unless you validate it',
          'Du kan aktivere feedback-moderering for hele siden. Dersom du gjør det vil ingen kommentarer eller trackbacks vises på bloggen din uten at du har godkjent dem'
  ...
  l.store 'Enabling spam protection will make typo compare the IP address of posters as well as the contents of their posts against local and remote blacklists. Good defense against spam bots',
          'Enabling spam protection will make typo compare the IP address of posters as well as the contents of their posts against local and remote blacklists. Good defense against spam bots'
  ...
  l.store 'Typo can (optionally) use the %s spam-filtering service.  You need to register with Akismet and receive an API key before you can use their service.  If you have an Akismet key, enter it here',
          'Typo can (optionally) use the %s spam-filtering service.  You need to register with Akismet and receive an API key before you can use their service.  If you have an Akismet key, enter it here'
  ...
  l.store "This setting allows you to disable trackbacks for every article in your blog.  It won't remove existing trackbacks, but it will prevent any further attempt to add a trackback anywhere on your blog.",
          'Denne innstillingen gir deg mulighet for å daktivere Trackbacks for hver artikkel i bloggen din. Eksisterende Trackbacks vil ikke fjernes, men det vil forhindre nye forsøk på å legge til Trackbacks over hele bloggen din.'
  ...
  l.store 'Typo will automatically reject comments and trackbacks which contain over a certain amount of links in them',
          'Typo will automatically reject comments and trackbacks which contain over a certain amount of links in them'
  ...
  l.store 'Remember to set your reCaptcha keys inside config/initializers/recaptcha.rb',
          'Husk å sette reCaptcha-nøklene dine i filen config/initializers/recaptcha.rb'
  ...
  l.store "You can allow users to register to your blog. By default, they will register as contributors, an unpriviledged account level which grant them no rights but own a profile on the site. If you don't want users to register, you can thus add them by yourself in the users part of this admin.",
          'Du kan tillate brukere å registrere seg på bloggen din. Som standard vil de registreres som bidragsytere, et upriviligert kontonivå som kun gir dem en egen profil på websiden. Dersom du ikke ønsker at brukere skal kunne registrere seg, så kan du legge dem til selv under brukerkontoer.'
  l.store 'Typo can notify you when new articles or comments are posted',
          'Typo kan gi deg beskjed når nye artikler eller kommentarer er mottatt'
  ...
  l.store 'You can use your Google Feedburner account instead of Typo feed URL. To enable this, fill this form with your Feedburner ID.',
          'Du kan bruke din Gooogle Feedburner-konto istedet for Typo feed URL. For å aktivere dette, fyll ut dette skjemaet med din Feedburner ID.'
  ...
  l.store "When publishing articles, Typo can send trackbacks to websites that you link to. This should be disabled for private blogs as it will leak non-public information to sites that you're discussing. For public blogs, there's no real point in disabling this.",
          'Når du publiserer artikler kan Typo sende trackbacks til de hjemmesider du lenker til. Dette bør deaktiveres for private blogger da det ellers kan lekke privat informasjion til hjemmesider du diskuterer. For offentlige blogger, er det ingen reell mening i å deaktivere dette.'
  ...
  l.store "Drag and drop to change the sidebar items displayed on this blog.  To remove items from the sidebar just click remove  Changes are saved immediately, but not activated until you click the 'Publish' button",
          "Dra og slipp for at Dra og slipp innholdsendreen der vises på denne blog. Du kan fjerne elementer fra oversiktsoversikten bare ved at klikke fjern. endringer gemmes med det samme, men ikke aktiveret, før du klikker på 'Offentliggør' knappen."
  ...
  l.store 'You can download third party themes from officially supported %s ',
          'Du kan laste ned tredjepartstemaer fra offisielt støttede %s '
  l.store 'Typogarden', ''
  l.store 'To install a theme you  just need to upload the theme folder into your themes directory. Once a theme is uploaded, you should see it on this page.',
          'For å installere et tema må du laste opp temakatalogen til themes-katalogen til Typo. Når et tema er lastet opp, vil du se det på denne siden.'
  ...
  l.store 'Oops, something wrong happened, the comment could not be saved',
          'Ojsann, noe galt skjedde. Kommentaren ble ikke lagret'
  ...
  l.store 'Use the following link to trackback from your own site',
          'Bruk følgende lenke for å opprette trackback fra din egen side'
  ...
  l.store "This comment has been flagged for moderator approval.  It won't appear on this blog until the author approves it",
          'Denne kommentaren har blitt flagget for godkjenning av moderator. Den vil ikke bli vist på bloggen før moderatoren godkjenner den.'

  # app/views/comments/show.html.erb
  l.store 'This comment has been flagged for moderator approval.',
          'Denne kommentaren har blitt flagget for godkjenning av moderator.'
  ...
  l.store 'Welcome to your %s blog setup. Just fill in your blog title and your email, and Typo will take care of everything else',
          'Velkommen til din %s bloggoppsett. Bare fyll inn bloggtittel og epostadressen din, så vil Typo ta seg av resten'
  ...
  l.store "Don't lose the mail sent at %s or you won't be able to login anymore",
          'Ikke mist eposten som ble sendt %s. Uten passordet vil du ikke kunne logge inn senere'
  ...
  l.store 'You can follow any response to this entry through the %s',
          'Du kan følge alle svar til denne artikkelen via %s'
  l.store 'Atom feed', ''
  ...
  l.store 'Error occurred while updating Content Type.',
          'En feil oppsto under oppdatering av innholdstype (Content Type)'
  ...
  l.store 'Jabber account to use when sending Jabber notifications',
          'Jabber-konto som skal brukes når du sender Jabber-meldinger'
  ...
  l.store 'Oops, something wrong happened. Have you filled out message and name?',
          'Ojsann, noe gikk galt. Har du fylt ut beskjed og navn?'
  ...
  l.store 'The below settings act as defaults when you choose to publish an enclosure with iTunes metadata',
          'Innstillingene under er standard når du velger å publisere et vedlegg med iTunes metadata'
  ...
  l.store 'This option let you choose between the simple admin interface or the complete one, displaying much more options and therefore more complicated to use. For advanced users only!',
          'Dette valget lar deg velge mellom et enkelt eller et komplett administrasjonsgrensesnitt. Det komplette viser mange flere valg og kan derfor være vanskeligere å bruke. Kun for avanserte brukere!'
  ...
  l.store 'Unchecking this box will add <code>noindex, follow</code> meta tags in every category page, removing them from search engines and preventing duplicate content issues',
          'Avmerking av denne boksen vil legge til <code>noindex, follow</code> meta tags i hver kategoriside, som fjerner dem fra søkemotorer og motvirker problemer som skyldes duplisert innhold'
  l.store 'Unchecking this box will add <code>noindex, follow</code> meta tags in every tags page, removing them from search engines and preventing duplicate content issues',
          'Avmerking av denne boksen vil legge til <code>noindex, follow</code> meta tags i hver tagsside, som fjerner dem fra søkemotorer og motvirker problemer som skyldes duplisert innhold'
  ...
  l.store 'You can enable site wide feedback moderation. If you do so, no comment or trackback will appear on your blog unless you validate it',
          'Du kan slå feedback moderation til for hele bloggen. Hvis du gør dette kommer kommentarer og trackbacks først frem når du har godkendt dem'
  l.store 'You can optionally disable non-Ajax comments. Typo will always use Ajax for comment submission if Javascript is enabled, so non-Ajax comments are either from spammers or users without Javascript.',
          'Du kan valgfritt deaktivere non-AJAX-kommentarer. Typo vil alltid bruke AJAX for kommentarinnsending dersom Javascript er aktivert, slik at non-AJAX-kommentarer enten kommer fra brukere uten Javascript eller fra spammere..'
  l.store 'You need a permalink format with an identifier : %%month%%, %%year%%, %%day%%, %%title%%',
          'Du må ha et permalenkeformat med en identifikator : %%month%%, %%year%%, %%day%%, %%title%%'
  ...
  l.store 'it has been illegally reproduced and without proper authorization',
          'så har den blitt reprodusert uten tillatelse'
