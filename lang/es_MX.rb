...
Localization.define('es_MX') do |l|
  ...
  l.store 'Are you sure you want to delete the category ',
          '&iquest;Est&aacute;s seguro que quieres eliminar esta categor&iacute;a?'
  ...
  l.store 'Are you sure you want to delete this article',
          '&iquest;Est&aacute;s seguro que deseas borrar este art&iacute;culo?'
  ...
  l.store 'Are you sure you want to delete the page',
          '&iquest;Est&aacute;s seguro que deseas eliminar esta p&aacute;gina?'
  ...
  l.store 'Typo can notify you when new articles or comments are posted',
          'Typo puede notificarte cuando nuevos art&iacute;culos o comentarios sean a&ntilde;adidos'
  l.store 'Source Email', 'Email remitente'
  l.store 'Email address used by Typo to send notifications',
          'Direcci&oacute;n de email usada por Typo para enviar notificaciones'
  l.store 'Enabling spam protection will make typo compare the IP address of posters as well as the contents of their posts against local and remote blacklists. Good defense against spam bots',
          'Habilitando la protecci&oacute;n anti-spam har&aacute; que typo compare la direcci&oacute;n IP del usuario as&iacute; como el contenido de sus comentarios contra una lista negra remota o local. Es una buena defensa contra los robots de spam'
  ...
  l.store 'Typo can (optionally) use the %s spam-filtering service.  You need to register with Akismet and receive an API key before you can use their service.  If you have an Akismet key, enter it here',
          'Typo puede (opcionalmente) usar el servicio anti-spam de %s. Necesitas registrarte en Akismet y obtener una API key antes de poder usar su servicio. Si tienes una clave de Akismet, introd&uacute;cela aqu&iacute;'
  ...
  l.store "This setting allows you to disable trackbacks for every article in your blog.  It won't remove existing trackbacks, but it will prevent any further attempt to add a trackback anywhere on your blog.",
          'Esta opci&oacute;n te permite deshabilitar trackbacks para cada art&iacute;culo en tu blog. Esto no remover&aacute; trackbacks existentes, pero impedir&aacute; cualquier intento futuro para a&ntilde;adir una trackback en cualquier parte de tu blog.'
  ...
  l.store 'Typo will automatically reject comments and trackbacks which contain over a certain amount of links in them',
          'Typo rechazar&aacute; autom&aacute;ticamente los comentarios y trackbacks que contengan m&aacute;s de un cierto n&uacute;mero de links en ellos'
  ...
  l.store "When publishing articles, Typo can send trackbacks to websites that you link to. This should be disabled for private blogs as it will leak non-public information to sites that you're discussing. For public blogs, there's no real point in disabling this.",
          'Cuando se publican art&iacute;culos, Typo puede enviar trackbacks a sitios enlazados. Esto deber&iacute;a deshabilitarse para blogs privados para que no se escape informaci&oacute;n privada a sitios que est&aacute;s comentando. Para blogs p&uacute;blicos, realmente no hay raz&oacute;n para deshabilitar esto.'
  ...
  l.store 'Drag some plugins here to fill your sidebar',
          'Arrastra algunos plugins aqu&iacute; para llenar tu barra lateral'
  ...
  l.store 'Send notification messages when new articles are posted',
          'Enviar notificaciones cuando un nuevo art&iacute;culo sea publicado'
  l.store 'Send notification messages when comments are posted',
          'Enviar notificaciones cuando un nuevo comentario sea publicado'
  ...
  l.store 'Currently this article is listed in following categories',
          'Este art&iacute;lo se encuentra en las siguientes categor&iacute;s'
  ...
  l.store 'Jabber account to use when sending Jabber notifications',
          'Cuenta de Jabber usada cuando se env&iacute;an notificaciones por Jabber'
  ...
  l.store 'The below settings act as defaults when you choose to publish an enclosure with iTunes metadata',
          'Las preferencias debajo son tomadas como predeterminadas cuando publicas contenido protegido con metadata de iTunes'
  ...
  l.store 'Which settings group would you like to edit',
          '&iquest;Qu&eacute; grupo de preferencias te gustar&iacute;a editar?'
  ...
  l.store 'You can enable site wide feedback moderation. If you do so, no comment or trackback will appear on your blog unless you validate it',
          'Puedes habilitar la moderaci&oacute;n de comentarios y trackbacks. Si lo haces, ning&uacute;n comentario o trackback aparecer&aacute; en tu blog hasta que lo hayas validado'
  l.store 'You can optionally disable non-Ajax comments. Typo will always use Ajax for comment submission if Javascript is enabled, so non-Ajax comments are either from spammers or users without Javascript.',
          'Puedes deshabilitar los comentarios sin Ajax. Typo usar&aacute; siempre Ajax para a&ntilde;adir un comentario si Javascript est&aacute; habilitado, as&iacute; que los comentarios sin Ajax son de spammers o de usuarios sin Javascript.'
  l.store 'by', 'por'
  l.store 'on', 'en'
