...
Localization.define('da_DK') do |l|
  ...
  l.store 'This place gives you a quick overview of what happens on your Typo blog and what you can do. Maybe will you want to %s, %s or %s.',
          'Dette sted giver dig en hurtig oversigt over, hvad der sker på din Typo blog, og hvad du kan gøre. Måske du ønsker at %s, %s eller %s.'
  ...
  l.store "No posts yet, why don't you start and write one",
          'Der er ingen artikler endnu, du kan evt. starte med at skrive en'
  ...
  l.store 'Typo can notify you when new articles or comments are posted',
          'Typo kan give dig besked, når nye artikler eller kommentarer er indsendt'
  l.store 'Source Email', 'Afsender e-mail'
  l.store 'Email address used by Typo to send notifications',
          'E-mail adresse der bruges af Typo til at sende meddelelser'
  ...
  l.store "This setting allows you to disable trackbacks for every article in your blog.  It won't remove existing trackbacks, but it will prevent any further attempt to add a trackback anywhere on your blog.",
          'Denne indstilling giver dig mulighed for at deaktivere Trackbacks for hver artikel i din blog. Det vil ikke fjerne eksisterende Trackbacks, men det vil forhindre yderligere forsøg på at tilføje Trackbacks overalt på din blog.'
  ...
  l.store "When publishing articles, Typo can send trackbacks to websites that you link to. This should be disabled for private blogs as it will leak non-public information to sites that you're discussing. For public blogs, there's no real point in disabling this.",
          'Når du udgiver artikler kan Typo sende trackbacks til de hjemmesider du linker til. Dette bør slåes fra for private blogs da det ellers kan lække privat information til hjemmesider du diskuterer. For offentlige blogs, er der ingen reel mening i at deaktivere dette.'
  ...
  l.store "Drag and drop to change the sidebar items displayed on this blog.  To remove items from the sidebar just click remove  Changes are saved immediately, but not activated until you click the 'Publish' button",
          "Træk og slip for at ændre indholdsoversigten der vises på denne blog. Du kan fjerne elementer fra indholdsoversigten bare ved at klikke fjern. Ændringer gemmes med det samme, men ikke aktiveret, før du klikker på 'Offentliggør' knappen."
  ...
  l.store "This comment has been flagged for moderator approval.  It won't appear on this blog until the author approves it",
          'Denne kommentar er blevet markeret som krævende godkendelse. Den vil ikke blive vist før forfatteren godkender den.'
  ...
  l.store 'Use the following link to trackback from your own site',
          'Brug følgende link til lave trackback fra din egen side'
  ...
  l.store 'Oops, something wrong happened. Have you filled out message and name?',
          'Hov der gik noget galt, har du udfyldt besked og dit navn?'
