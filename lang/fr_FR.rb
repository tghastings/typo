...
Localization.define('fr_FR') do |l|
  ...
  l.store 'An email has been successfully sent to your address with your new password',
          'Un courrier vous a été envoyé avec votre nouveau mot de passe'
  ...
  l.store 'Oops, something wrong happened. Cache could not be cleaned',
          "Oops, un problème s'est produit et le cache n'a pas pu être vidé correctement"
  ...
  l.store 'Error, you are not allowed to perform this action',
          "Erreur, vous n'avez pas les droits requis pour effectuer cette action"
  ...
  l.store 'You are late from at least one major version of Typo. You should upgrade immediately. Download and install %s',
          'Vous avez au moins une version majeure de Typo de retard. Vous devriez immédiatement vous mettre à jour. Téléchargez et installez %s'
  l.store 'the latest Typo version', 'la dernière version de Typo'
  l.store "There's a new version of Typo available which may contain important bug fixes. Why don't you upgrade to %s ?",
          "Une nouvelle version de Typo est disponible. Celle-ci contient probablement d'importants correctifs. Pourquoi ne téléchargeriez-vous pas %s"
  l.store "There's a new version of Typo available. Why don't you upgrade to %s ?",
          "Une nouvelle version de Typo est disponible. Pouquoi n'installeriez-vous pas %s"
  ...
  l.store 'Please review and save the settings before continuing',
          'SVP vérifiez et enregistrez votre configuration avant de continuer'
  ...
  l.store 'It seems something went wrong. Maybe some of your sidebars are actually missing and you should either reinstall them or remove them manually',
          "Une erreur s'est produite. Un ou plusieurs plugins sont probablement manquants ou en erreur. Peut-être devriez-vous les supprimer ou les réinstaller"
  ...
  l.store "There are no %s yet. Why don't you start and create one?",
          "Il n'y a pas encore de %s, pourquoi ne pas en créer un ? "
  l.store 'Save', 'Sauver'
  l.store 'or', 'ou'
  l.store 'Short url:', ''
  l.store 'Edit', 'Éditer'
  ...
  l.store "Can't end in .rss or .atom. These are reserved to be used for feed URLs",
          'Ne peut pas se terminer par .rss ou .atom. Cette extension est réservée aux flux de syndication'
  ...
  l.store 'To save resources Typo caches content in static files. Cache is cleared each time something gets published. You may however want to clear the cache by yourself',
          "Afin d'économiser des ressources, Typo génère des fichiers statiques avec votre contenu. Ces fichiers sont supprimés lors d'une nouvelle publication. Vous pouvez cependant les effacer vous même."
  l.store 'There are currently %d files in cache for a total amount of %d Kb',
          'Il y a actuellement %d fichiers en cache pour un total de %d kilo octets.'
  ...
  l.store 'Currently this article has the following resources',
          'Les fichiers suivants sont actuellement liés à ce billet'
  ...
  l.store 'Excerpts are posts summaries that are shown on your blog homepage only but won’t appear on the post itself',
          "Les résumés vous permettent d'afficher un texte descriptif de votre article à la place de ce dernier sur la page d'accueil de votre blog"
  ...
  l.store 'This place gives you a quick overview of what happens on your Typo blog and what you can do. Maybe will you want to %s, %s or %s.',
          'Voici un rapide aperçu de ce que peut faire votre blog Typo. Peux-être voulez vous %s, %s ou %s'
  ...
  l.store "No posts yet, why don't you start and write one",
          "Vous n'avez encore écrit aucun article, pourquoi ne pas commencer par là"
  ...
  l.store '%d articles and %d comments were posted since your last connexion',
          'Depuis votre dernière connexion, %d articles et %d commentaires ont été publiés'
  ...
  l.store 'This comment by <strong>%s</strong> was flagged as spam, %s?',
          'Ce commentaire de <strong>%s</strong> a été marqué comme spam, %s ?'
  ...
  l.store 'Checking this box will add <code>noindex, follow</code> meta tags in every category page, removing them from search engines and preventing duplicate content issues',
          'Sélectionner cette option ajoutera le métalabel <code>noindex, follow</code> dans toutes les pages de chaque categorie. Cela les enlevera des moteurs de recherches et préviendra ainsi des problèmes de contenu dupliqué.'
  ...
  l.store 'Checking this box will add <code>noindex, follow</code> meta tags in every tags page, removing them from search engines and preventing duplicate content issues',
          'Sélectionner cette option ajoutera le métalabel <code>noindex, follow</code> dans toutes les pages de chaque label. Cela les enlevera des moteurs de recherches et préviendra ainsi des problèmes de contenu dupliqué.'
  l.store 'Robots.txt', 'Robots.txt'
  l.store "You robots.txt file is not writeable. Typo won't be able to write it",
          'Typo ne peut pas écrire dans votre fichier robots.txt.'
  ...
  l.store 'Maybe you want to moderate feedbacks when turning this on',
          'Si vous activez cette option, peut-être devriez-vous également activer la modération des commentaires.'
  ...
  l.store 'Here are some examples to get you started.',
          "Typo vous offre la possibilité de créer une structure d'URL personnalisée pour vos liens permanents et vos archives. Cela peut vous permettre d'améliorer l'esthétique, l'utilisabilité et la viralité de vos liens."
  ...
  l.store 'You can custom your URL structure using the following tags:',
          "Vous pouvez personnaliser la structure de vos URL à l'aide des tags suivats:"
  l.store 'your article slug. <strong>Using this slug is mandatory</strong>.',
          'le permalien de votre article <strong>ce champ est obligatoire</strong>'
  ...
  l.store 'Replaced with the article tags (comma separated)',
          "Remplacé par les tags de l'article (séparés par une virgule)"
  l.store 'Replaced with the article categories (comma separated)',
          "Remplacé par les catégories de l'article (séparées par une virgule)"
  ...
  l.store 'You can enable site wide feeback moderation. If you do so, no comment or trackback will appear on your blog unless you validate it',
          "Vous pouvez activez la modération des commentaires sur l'ensemble de votre site. Si vous le faites, aucun commentaire ou rétrolien ne sera publié sans une validation de votre part"
  ...
  l.store 'Enabling spam protection will make typo compare the IP address of posters as well as the contents of their posts against local and remote blacklists. Good defense against spam bots',
          "La protection contre le spam permettra à typo de comparer l'adresse IP des commentateurs ainsi que le contenu de leurs commentaires avec une liste noire distante"
  ...
  l.store 'Typo can (optionally) use the %s spam-filtering service.  You need to register with Akismet and receive an API key before you can use their service.  If you have an Akismet key, enter it here',
          "Typo peut utiliser le service de lutte contre le spam %s. Vous devez vous enregistrer afin de pouvoir utiliser les services d'Akismet. Si vous possédez une clé Akismet, ajoutez là ici"
  ...
  l.store "This setting allows you to disable trackbacks for every article in your blog.  It won't remove existing trackbacks, but it will prevent any further attempt to add a trackback anywhere on your blog.",
          "Cette option vous permet de désactiver totalement les rétroliens sur votre blog. Ceci ne supprimera pas les rétroliens existants, mais empêchera tout nouveau rétrolien d'être créé"
  l.store 'Disable comments after', 'Désactiver les commentaires au bout de '
  l.store 'days', 'jours'
  l.store 'Set to 0 to never disable comments',
          'Mettez cette option à 0 pour ne jamais désactiver les commentaires dans le temps'
  ...
  l.store 'Typo will automatically reject comments and trackbacks which contain over a certain amount of links in them',
          'Typo rejettera automatiquement les commentaires et les rétroliens contenant un certain nombre de liens'
  ...
  l.store 'Remember to set your reCaptcha keys inside config/initializers/recaptcha.rb',
          "N'oubliez pas de mettre votre clé d'activation dans config/initializers/recaptcha.rb"
  ...
  l.store 'Typo can notify you when new articles or comments are posted',
          'Typo peut vous alerter quand de nouveaux articles et commentaires sont publiés'
  l.store 'Source Email', 'Adresse courriel source'
  l.store 'Email address used by Typo to send notifications',
          "Adresse courriel utilisée par Typo pour l'envoi d'alertes"
  ...
  l.store 'You can use your Google Feedburner account instead of Typo feed URL. To enable this, fill this form with your Feedburner ID.',
          "Vous pouvez utiliser votre compte Google Feedburner plutôt que votre adresse de flux Typo. Pour l'autoriser, remplissez ce formulaire avec votre identifiant Feedburner."
  ...
  l.store "When publishing articles, Typo can send trackbacks to websites that you link to. This should be disabled for private blogs as it will leak non-public information to sites that you're discussing. For public blogs, there's no real point in disabling this.",
          "Quand vous publiez un billet sur Typo, vous pouvez envoyer un rétrolien aux sites que vous liez. Cette fonctionnalité devrait être désactivée pour les blogs privée puisqu'elle permet de donner des informations à leur sujet à des tiers. Ceci ne s'impose cependant pas pour un blog public."
  ...
  l.store 'Drag some plugins here to fill your sidebar',
          'Déplacez des plugins dans cet espace afin de remplir votre sidebar'
  ...
  l.store "Drag and drop to change the sidebar items displayed on this blog.  To remove items from the sidebar just click remove  Changes are saved immediately, but not activated until you click the 'Publish' button",
          "Glissez / déplacez des éléments pour changer la sidebar de votre blog. Pour supprimer un élément de votre sidebar, cliquez simplement sur 'supprimer'. Les changements sont effectués immédiatement, mais ne seront pas actifs tant que vous n'aurez pas cliqué sur le bouton 'Publier'."
  ...
  l.store 'Send notification messages when new articles are posted',
          'Envoi de notification de messages quand de nouveaux articles sont postés'
  l.store 'Send notification messages when comments are posted',
          'Envoi de notification de messages quand des commentaires sont postés'
  ...
  l.store 'Oops, something wrong happened, the comment could not be saved',
          "Oops, quelque chose s'est mal déroulé. Votre commentaire n'a donc pu être enregistré."
  ...
  l.store 'Use the following link to trackback from your own site',
          'Utilisez le lien ci-dessous pour envoyer un rétrolien depuis votre site'
  ...
  l.store "This comment has been flagged for moderator approval.  It won't appear on this blog until the author approves it",
          "Ce commentaire a été envoyé à la modération. Il ne sera affiché qu'une fois approuvé par un modérateur"
  ...
  l.store "Don't lose the mail sent at %s or you won't be able to login anymore",
          "Ne perdez pas l'email que nous venons de vous envoyer à l'adresse %s ou vous ne pourrez plus vous connecter à l'application"
  ...
  l.store 'You can follow any response to this entry through the %s',
          'Vous pouvez suivre la discussion autour de cet article via le %s'
  ...
  l.store 'Error occurred while updating Content Type.',
          'Une erreur est survenue lors de la mise à jour du type du contenu.'
  ...
  l.store 'If you need help, %s. You can also browse our %s or %s to customize your Typo blog.',
          "Si vous avez besoin d'aide, n'hésitez pas à %s. Vous pouvez aussi visiter notre %s ou %s afin de personnaliser votre blog sous Typo"
  ...
  l.store 'The below settings act as defaults when you choose to publish an enclosure with iTunes metadata',
          'Les options suivantes seront ajoutées automatiquement quand vous publierez des enclosures contenant des métadonnées iTunes'
  ...
  l.store "There is no %s yet. Why don't you start and create one?",
          "Il n'y a aucun %s, pourquoi n'en créeriez-vous pas ?"
  l.store 'Thu', 'Jeu'
  ...
  l.store 'To install a theme you  just need to upload the theme folder into your themes directory. Once a theme is uploaded, you should see it on this page.',
          "Pour installer votre thèmes, il suffit de l'uploader dans le dossier themes de votre projet."
  l.store 'Tue', 'Mar'
  ...
  l.store 'You can download third party themes from officially supported %s ',
          'Vous pouvez télécharger des thèmes officiellement supportés sur %s '
  l.store 'You can optionally disable non-Ajax comments. Typo will always use Ajax for comment submission if Javascript is enabled, so non-Ajax comments are either from spammers or users without Javascript.',
          "Vous pouvez désactiver l'envoi des commentaires en AJAX. Typo utilisera toujours l'AJAX par défaut pour envoyer les commentaires si Javascript est activé. Désactiver l'AJAX sert donc aux gens ne disposant pas de Javascript et aux robots spammeurs"
  l.store 'You need a permalink format with an identifier : %%month%%, %%year%%, %%day%%, %%title%%',
          'Vous devez spécifier un identifiant : %%month%%, %%year%%, %%day%%, %%title%%'
  l.store "Your robots.txt file is not writeable. Typo won't be able to write it",
          "Votre fichier Robots.txt n'est pas écrivable. Typo ne peux donc pas y écrire."
  l.store 'add a comment', 'Ajouter un commentaire'
  ...
  l.store 'it has been illegally reproduced and without proper authorization',
          "c'est qu'il a été reproduit illégalement et sans autorisation"
